...
public class Mapas implements Executable {
	...
	public void run() {
		...
		for (int i = 0; i < 5; i++) {
			Persona p = new Persona(CAT.toGetName(), CAT.toGetID(), CAT.toGetInteger(18, 65));
